...
export type PricingConfig = {
  ...
  tiermap: { review_pages: number; size_band_max: number; blog_seo_threshold: number; extra_page_cap: number; presence_max_pages: number; standard_base_pages: number; pro_base_pages: number; pro_includes: string[]; presence_excludes_components: boolean; presence_excludes_bilingual: boolean };
};
...
export function loadPricingConfig(raw: unknown): PricingConfig {
  ...
  check(typeof tm.presence_excludes_components === "boolean", "tiermap.presence_excludes_components must be boolean (#38)"); // #22/#38
  check(typeof tm.presence_excludes_bilingual === "boolean", "tiermap.presence_excludes_bilingual must be boolean (#38)");
  ...
  return Object.freeze({
    ...
    tiermap: { review_pages: tm.review_pages, size_band_max: tm.size_band_max, blog_seo_threshold: tm.blog_seo_threshold, extra_page_cap: tm.extra_page_cap, presence_max_pages: tm.presence_max_pages, standard_base_pages: tm.standard_base_pages, pro_base_pages: tm.pro_base_pages, pro_includes: [...tm.pro_includes], presence_excludes_components: tm.presence_excludes_components, presence_excludes_bilingual: tm.presence_excludes_bilingual },
  }) as PricingConfig;
}
